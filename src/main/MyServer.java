...
import networkutils.CommandReceiver;
import operation.OperationData;
import operation.OperationDecode;
import utils.MouseUtil;

public class MyServer {
    private static final float MOVE_RATIO = 0.2f;
    public static void main(String[] args) {
        CommandReceiver receiver = new CommandReceiver(new CommandReceiver.DeliveryCommand() {
